...
describe GSheets::Session do
  context "sanity check" do
    ...
    context "it initializes an instance" do
      Given(:code) { "access_token" }
      When(:session_instance) { session_class.new(access_token: code) }
  ...
  context "retrieval" do
    ...
    Given(:session_instance) { session_class.new(access_token: code, http_client: http_client) }
    Given(:code) { "access_token" }
    Given(:id) { "id" }
